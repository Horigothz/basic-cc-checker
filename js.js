function notifyMe(message, status, progress) {
      ...
      function start() {
          ...
          if (lista.length == 0) {
              ...
              //notifyMe("Você precisa carregar uma lista antes de iniciar o TESTEDr!", "Erro ao iniciar.");
              audio2.play();
              return;
          } else {
              document.getElementById("demo").innerHTML = 'START.';
              audio.play();
              //notifyMe("Sua lista para checagem das cc's foi enviada com sucesso, estamos iniciando o TESTEDr!", "Iniciando testes.");
          }
          var i;
          var lista = $('#lista').val();
          var cc = lista.split("\n");
      ...
      function stop() {
          ...
          document.getElementById("loaded").innerHTML = textareaMatch;
      ...
      function check(cc2, separador, id) {
                    ...
                    xmlhttp.onreadystatechange = function()
                    {
                        ...
                        if (xdata.match("Aprovada")) {
                          ...
                          document.getElementById("TESTED").innerHTML = (eval(document.getElementById("TESTED").innerHTML) + 1);
                          document.getElementById("LIVE").innerHTML = (eval(document.getElementById("LIVE").innerHTML) + 1);
                          ...
                          play();
                          console.log('{"Success":"', document.getElementById("TESTED").innerHTML, '":"true"}')

                      } else if (xdata.match("Reprovada")) {
                          document.getElementById("demo").innerHTML = 'DECLINED !';
                          document.getElementById("TESTED").innerHTML = (eval(document.getElementById("TESTED").innerHTML) + 1);
                          document.getElementById("DEAD").innerHTML = (eval(document.getElementById("DEAD").innerHTML) + 1);
                          ...
                          rmLinha('#lista');
                          console.log('{"Success":"', document.getElementById("TESTED").innerHTML, '":"false"}')
